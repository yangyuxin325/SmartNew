...
class SmartServer(object):
    ...
    taskQueue = Queue()
    runFlag = True
    mysqlConnect_data =  torndb.Connection("127.0.0.1:3306", "sample", user = "root", password = "123456")
    mysqlConnect_task =  torndb.Connection("127.0.0.1:3306", "sample", user = "root", password = "123456")
