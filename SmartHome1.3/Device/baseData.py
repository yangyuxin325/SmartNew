...
class devBaseData():
    def __init__(self, name, constraint, data_id, value):
        self._name = name
    ...
    def getDataItem(self):
        return {'data_id' : self._data_id, 'value' : self.DataValue, 'data_name' : self.DataName, 'updatetime' : self.DataUpdateTime}
