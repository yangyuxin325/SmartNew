...
class stc_1():
    ...
    def _D_IOParse(self, data):
        try:
            ...
            logging.error("mokuai _D_IOParse")
    ...
    def _AIParse(self, data):
        try:
            ...
            logging.error("mokuai _AIParse")
        
    def dataParse(self, data):
        logging.info('mokuai received data : %s' % str(data))
