...
class devBaseData():
    ...
    def __str__(self):
        ...
        if self._next_data is not None:
            str2 = "\nDataName = " + self._next_data._name + ", " \
            + "Value = " + str(self._next_data._value) + ", " \
            + "UpdateTime = " + str(self._next_data._time)
            
        str3 = ""
        if len(self._Averge_datalist) != 0:
            for item in self._Averge_datalist:
                str3 += "\nDataName = " + item[0]._name + ", " \
                + "Value = " + str(item[0]._value) + ", " \
                + "UpdateTime = " + str(item[0]._time)
